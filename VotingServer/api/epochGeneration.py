...
def generate_voteamount():
    ...
    voteamount = generator.integers(low=15, high=20, size=None, dtype=np.int64, endpoint=True) # endpoint=true makes both low and high inclusive. Range is therefore 800-1200.
    return voteamount
